function MyAbout() {
    ...
    let home_about = [{
        ...
        about_content: "Physiotherapy is a field of health care that aims to rehabilitate and improve health of people with movement disabilities. Basic methods that are used include relevant exercises, motivation, adapted equipment, education and advocacy. Physiotherapy deals with the interaction between physical therapists and patients is a field of health care that aims to rehabilitate and improve health of people with movement disabilities. Basic methods that are used include relevant exercises, motivation, adapted equipment, education and advocacy. Physiotherapy deals with the interaction between physical therapists and patients.",
